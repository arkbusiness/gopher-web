...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <div className="w-9 h-9 flex justify-center items-center bg-accent">
          <ChevronRightIcon className="text-primary pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200" />
        </div>
      </AccordionPrimitive.Trigger>
